...
# Find any listed character one or more times:
# 	lower/upper case letters
# 	digits 0-9
# 	'.' is a metacharacter, but square brackets tell Python to find a literal match
# 	'\', '_' or '-'.
# Followed by:
# 	'@'
# 	one or more listed characters
# 	'\' tells Python to find '.' literally
# 	2-4 lower/upper case letters.
# Finds simple, valid emails. Also finds invalid emails, where '.' appears two or more times consecutively, or is the first character.
